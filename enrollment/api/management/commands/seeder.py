...
class Command(BaseCommand):
    ...
    def create_prerequisites(self):
        ...
        # Retrieve all courses to avoid repeated queries
        course_instances = {course.code: course for course in Course.objects.all()}
        ...
        for prereq in pre_requisites:
            ...
            target_course = course_instances.get(course_code)
            ...
            for pre_req_code in pre_req_codes:
                pre_req_course = course_instances.get(pre_req_code)
